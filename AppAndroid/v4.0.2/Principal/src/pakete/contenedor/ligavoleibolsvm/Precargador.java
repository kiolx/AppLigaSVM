...
public class Precargador extends SherlockActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //las demas llamadas de funciones se realizan despues
}
    ...
    public void ArrancarDatosBDApp(){
       ...
       valuesOpciones.put("jornadaactual", "10");
       ...
       ContentValues valuesMVPySepteto = new ContentValues();
       valuesMVPySepteto.put("urlsepteto", "http://mobil.cavesquimo.es/descargas/septeto/septeto.png");
       valuesMVPySepteto.put("urlmvp", "http://mobil.cavesquimo.es/descargas/mvp/mvp.png");
       valuesMVPySepteto.put("descripcionmvp", "No descripcion avalaible");
       db.insert(DBHelper.TABLAmvpysepteto, null, valuesMVPySepteto);       
    ...
    public void descargarSeptetoMVPFicheroParseo(){
    	new DownloadFileFromURL().execute("http://mobil.cavesquimo.es/descargas/parseo/parseo.php");
    }
	...
	public void leerYparsear() { 
		...
		DBHelper dbHelper = new DBHelper(Precargador.this);
		SQLiteDatabase db = dbHelper.getWritableDatabase();	
		String nombreStr = "";  String emailStr = "";  String urllStr = ""; String fuentedatosStr = ""; String notafinalStr =""; String actualizacion=""; String jornadaactual="";
		try {
			...
			NodeList nList3 = doc.getElementsByTagName("datosopciones");
	 		for (int temp = 0; temp < nList3.getLength(); temp++) { 
			   ...
			   if (nNode3.getNodeType() == Node.ELEMENT_NODE) {
			      ...
			      jornadaactual = getTagValue("jornadaactual", eElement);
			   }}
			
			db.execSQL("UPDATE opciones SET actualizacion='"+actualizacion+"', jornadaactual='"+jornadaactual+"' WHERE id_opcion='1'");
			...
			/*Inicio inserccion de MVP Y SEPTETO*/
			NodeList nList6 = doc.getElementsByTagName("datosmvpsepteto");
	 		for (int temp = 0; temp < nList6.getLength(); temp++) { 
			   Node nNode6 = nList6.item(temp);
			   if (nNode6.getNodeType() == Node.ELEMENT_NODE) {
			      Element eElement = (Element) nNode6;
			      String urlsepteto = getTagValue("urlsepteto", eElement);
			      String urlmvp = getTagValue("urlmvp", eElement);
			      String descripcionmvp = getTagValue("descripcionmvp", eElement);
			     db.execSQL("UPDATE mvpysepteto SET urlsepteto='"+urlsepteto+"' , urlmvp='"+urlmvp+"' , descripcionmvp='"+descripcionmvp+"' WHERE id_mvpsepteto='1'");
			   }}			
			 /*FIN inserccion de clasificacion*/
		...
		db.close();
	   	dbHelper.close(); 
	   	Intent ArranquePrincipal = new Intent(Precargador.this, Principal.class); startActivity(ArranquePrincipal); finish();
	   	estadoAlante=4;//orden de arrancar el otro activity apra el timer
	  }
	  ...
	  class DownloadFileFromURL extends AsyncTask<String, String, String> {
	      ...
	      protected String doInBackground(String... f_url) {
	          ...
	          try {
	              ...
	              OutputStream output = new FileOutputStream("data/data/pakete.contenedor.ligavoleibolsvm/SVM/parseo/parseo.xml");
