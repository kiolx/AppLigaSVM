...
public class ClasificacionActivity extends SherlockActivity {
    ...
    public void descargarImagenAsincronicamente(){
    	...
    	client.get("http://mobil.cavesquimo.es/descargas/septeto/septeto.jpg", new BinaryHttpResponseHandler(allowedContentTypes) {
    	    @Override
    	...
    	client.get("http://mobil.cavesquimo.es/descargas/mvp/mvp.jpg", new BinaryHttpResponseHandler(allowedContentTypes) {
    	    @Override
    	    public void onSuccess(byte[] fileData) {
    	    	try{
