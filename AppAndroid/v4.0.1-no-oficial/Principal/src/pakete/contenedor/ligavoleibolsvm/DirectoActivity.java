...
public class DirectoActivity extends SherlockListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(cadenaLLegada1.equals("ultima")){fila = db.rawQuery("SELECT * FROM partidos ORDER BY id_partido ASC LIMIT '5'",null);}else{fila = db.rawQuery("SELECT * FROM partidos WHERE jornada='"+cadenaLLegada1+"' ORDER BY id_partido ASC LIMIT '5'",null);}
